...
import type { ScheduledJob } from '../../../../lib/admin-types';
    ...
    <div>
      ...
      >
        ...
        <div style={{ ...s.panel, padding: '1rem 1.25rem' }}>
          ...
          <div style={{ fontSize: '1.75rem', fontWeight: 800, color: T.warn, marginTop: 6 }}>
            {disabled}
          </div>
        </div>
        {data && (
          <div style={{ ...s.panel, padding: '1rem 1.25rem' }}>
            ...
            <div style={{ fontSize: '0.875rem', fontWeight: 600, color: T.textDim, marginTop: 6 }}>
              {formatTime(data.run_at)}
            </div>
          </div>
        )}
      </div>
              ...
              <tbody>
                {jobs.map((job) => (
                  <tr key={job.jobid}>
                    ...
                    <td style={{ ...s.td, fontFamily: 'monospace', fontSize: '0.75rem' }}>
                      {job.schedule}
                    </td>
                    <td style={s.td}>
                      {job.active ? (
