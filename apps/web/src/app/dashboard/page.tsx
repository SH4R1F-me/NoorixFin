...
export default function DashboardPage() {
  ...
  const summaryCards = [
    ...
    {
      title: 'নিট ক্যাশ ফ্লো',
      titleEn: 'Net Cash Flow',
      amount: '৳ 42,650.00',
      change: '+25.8%',
      positive: true,
      icon: ArrowLeftRight,
  ...
  const recentTransactions = [
    { payee: 'মুদির দোকান', amount: -1250, category: 'খাদ্য', date: 'আজ' },
    { payee: 'মাসিক বেতন', amount: 85000, category: 'আয়', date: 'আজ' },
    { payee: 'বিদ্যুৎ বিল', amount: -2500, category: 'বিল', date: 'গতকাল' },
    { payee: 'বাসা ভাড়া', amount: -15000, category: 'আবাসন', date: 'গতকাল' },
    { payee: 'ফ্রিল্যান্স প্রজেক্ট', amount: 25000, category: 'আয়', date: '২ দিন আগে' },
  ];

  const upcomingBills = [
    { name: 'ইন্টারনেট বিল', amount: 1500, due: '৫ দিন বাকি', icon: '🌐' },
    { name: 'গ্যাস বিল', amount: 800, due: '১০ দিন বাকি', icon: '🔥' },
    { name: 'মোবাইল রিচার্জ', amount: 500, due: '১২ দিন বাকি', icon: '📱' },
  ];
