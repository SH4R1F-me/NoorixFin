...
const NAV_ITEMS = [
  ...
  { id: 'family', label: 'পরিবার', labelEn: 'Family', icon: Users, href: '/dashboard/family' },
      ...
      >
        ...
        <div style={styles.sidebarHeader}>
          <div style={styles.logoContainer}>
            ...
            {!collapsed && (
              <span style={styles.logoLabel}>MyFin</span>
            )}
          </div>
          <button
      ...
      <main style={{
        ...
        <div style={styles.mobileHeader}>
          ...
          <div style={styles.mobileLogoContainer}>
            ...
            <span style={{ ...styles.logoLabel, fontSize: '1.125rem' }}>MyFin</span>
          </div>
        </div>
