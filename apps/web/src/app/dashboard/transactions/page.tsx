...
const MOCK_TXS = [
  ...
  { id: '2', type: 'INCOME', payee: 'TechCorp Ltd', amount: 8500000, cat: 'Salary', catIcon: '💰', account: 'DBBL Bank', date: '2026-08-01', note: 'August salary' },
  { id: '3', type: 'EXPENSE', payee: 'Uber Ride', amount: 24500, cat: 'Transport', catIcon: '🚗', account: 'bKash', date: '2026-08-01', note: '' },
  { id: '4', type: 'TRANSFER', payee: 'bKash → Cash', amount: 500000, cat: 'Transfer', catIcon: '🔄', account: 'bKash → Cash', date: '2026-07-31', note: 'ATM' },
  { id: '5', type: 'EXPENSE', payee: 'Netflix', amount: 99000, cat: 'Entertainment', catIcon: '🎮', account: 'DBBL Card', date: '2026-07-30', note: 'Subscription' },
  { id: '6', type: 'INCOME', payee: 'Freelance Project', amount: 1500000, cat: 'Freelance', catIcon: '💻', account: 'Nagad', date: '2026-07-29', note: 'Logo design' },
  { id: '7', type: 'EXPENSE', payee: 'Electric Bill', amount: 320000, cat: 'Utilities', catIcon: '💡', account: 'DBBL Bank', date: '2026-07-28', note: 'July bill' },
  { id: '8', type: 'EXPENSE', payee: 'Pharmacy', amount: 85000, cat: 'Healthcare', catIcon: '🏥', account: 'Cash', date: '2026-07-27', note: '' },
];
