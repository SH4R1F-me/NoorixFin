...
const SYSTEM_CATEGORIES = [
  { id: '1', name: 'Food & Dining', type: 'EXPENSE', icon: '🍕', color: '#f59e0b', isSystem: true },
  { id: '2', name: 'Transport', type: 'EXPENSE', icon: '🚗', color: '#3b82f6', isSystem: true },
  { id: '3', name: 'Housing', type: 'EXPENSE', icon: '🏠', color: '#8b5cf6', isSystem: true },
  { id: '4', name: 'Utilities', type: 'EXPENSE', icon: '💡', color: '#06b6d4', isSystem: true },
  { id: '5', name: 'Healthcare', type: 'EXPENSE', icon: '🏥', color: '#ef4444', isSystem: true },
  { id: '6', name: 'Education', type: 'EXPENSE', icon: '📚', color: '#6366f1', isSystem: true },
  { id: '7', name: 'Entertainment', type: 'EXPENSE', icon: '🎮', color: '#ec4899', isSystem: true },
  { id: '8', name: 'Shopping', type: 'EXPENSE', icon: '🛍️', color: '#f97316', isSystem: true },
  { id: '9', name: 'Personal Care', type: 'EXPENSE', icon: '💈', color: '#14b8a6', isSystem: true },
  { id: '10', name: 'Gifts & Donations', type: 'EXPENSE', icon: '🎁', color: '#a855f7', isSystem: true },
  { id: '11', name: 'Other Expense', type: 'EXPENSE', icon: '📦', color: '#64748b', isSystem: true },
  { id: '12', name: 'Salary', type: 'INCOME', icon: '💰', color: '#10b981', isSystem: true },
  { id: '13', name: 'Business', type: 'INCOME', icon: '💼', color: '#059669', isSystem: true },
  { id: '14', name: 'Freelance', type: 'INCOME', icon: '💻', color: '#0ea5e9', isSystem: true },
  { id: '15', name: 'Investment', type: 'INCOME', icon: '📈', color: '#22c55e', isSystem: true },
  { id: '16', name: 'Other Income', type: 'INCOME', icon: '💵', color: '#84cc16', isSystem: true },
  { id: '17', name: 'Groceries', type: 'EXPENSE', icon: '🛒', color: '#34d399', isSystem: false },
  { id: '18', name: 'Subscriptions', type: 'EXPENSE', icon: '📺', color: '#c084fc', isSystem: false },
];
...
export default function CategoriesPage() {
  ...
  const filtered = SYSTEM_CATEGORIES.filter(c => filter === 'ALL' || c.type === filter);
  ...
  const renderCategory = (c: typeof SYSTEM_CATEGORIES[0]) => {
    ...
    return (
      <div key={c.id} style={s.listRow}>
        ...
        <span style={{ ...s.listBadge, background: c.type === 'EXPENSE' ? 'rgba(239,68,68,0.1)' : 'rgba(16,185,129,0.1)', color: c.type === 'EXPENSE' ? '#ef4444' : '#10b981' }}>
          {c.type}
        </span>
