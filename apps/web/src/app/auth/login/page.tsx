...
export default function LoginPage() {
  ...
  const t = {
    bn: {
      ...
      features: ['আয়-ব্যয় ট্র্যাকিং', 'বাজেট পরিকল্পনা', 'পারিবারিক ওয়ার্কস্পেস', 'সুরক্ষিত ও প্রাইভেট'],
    ...
    en: {
      ...
      features: ['Income & Expense Tracking', 'Budget Planning', 'Family Workspace', 'Secure & Private'],
